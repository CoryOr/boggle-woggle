...
3. From the Project_3c root folder, cd into the backend folder
   1. Type ./gradlew bootRun in the terminal and press enter to start the backend on localhost:8080
4. From a new terminal window, navigate to Project_3c root folder and cd into the frontend folder
...
- Once here, run "docker compose up"
