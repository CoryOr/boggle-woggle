...
const GameBoard = ({ board, updateScore }) => {
    ...
    const { gameId, setCurrentGuess, foundWords, setFoundWords, setInvalidWord } = useContext(CurrentGameContext);
    ...
    }, [gameId, updateScore, setCurrentGuess, foundWords, setFoundWords, setInvalidWord]);
